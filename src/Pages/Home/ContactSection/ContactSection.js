      ...
      <div className="row gx-5">
        <div className="col">
          <div className="p-3 w-75 mx-auto">
            <h2 className="fw-bolder blue-color">Health plus</h2>
            <p className="fw-bold text-secondary">Health Plus ensures the best health care as well as clinical service with outstanding personal service. We ensures the best health care as well as clinical service with outstanding personal service.</p>
            <p className="mt-4">
